...
var ItemOverrides = []*proto.UIItem{
	...
	{
		Id:         132008,
		Name:       "Atiesh, Greatstaff of the Guardian (Whitemane P3)",
		...
		Stats: stats.Stats{
			stats.Stamina:    108,
			stats.Intellect:  128,
			stats.SpellPower: 701,
			stats.SpellCrit:  144,
			stats.SpellHaste: 137,
			stats.MeleeCrit:  144,
			stats.MeleeHaste: 137,
		}.ToFloatArray(),
	...
	},
	{
		...
		Stats: stats.Stats{
			...
			stats.SpellPower: 701,
			stats.SpellCrit:  117,
			stats.SpellHaste: 117,
			stats.MeleeCrit:  117,
			stats.MeleeHaste: 117,
		}.ToFloatArray(),
		GemSockets: []proto.GemColor{
			proto.GemColor_GemColorRed,
			proto.GemColor_GemColorBlue,
